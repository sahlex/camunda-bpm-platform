...
define(["angular"], function(angular) {
  ...
  var module = angular.module("camunda.common.services");
  ...
  function AuthenticationFactory($http, $cookies, $q, Uri) {
    ...
    Authentication.prototype.login = function(username, password) {
      var self = this,
          promise = $http.post(Uri.appUri("app://auth/login"), { username: username, password: password });
    ...
    Authentication.prototype.logout = function() {
      var self = this,
          promise = $http.get(Uri.appUri("app://auth/logout"));
